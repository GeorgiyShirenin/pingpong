...
racket1 = Player('DOSKA.png', 30, 200, 4, 50, 150) # при созданни спрайта добавляется еще два параметра
racket2 = Player('DOSKA.png', 520, 200, 4, 50, 150)
ball = GameSprite('Is-360_4-removebg-preview.png', 200, 200, 4, 50, 50)
